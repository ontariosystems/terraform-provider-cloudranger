...
type GlobalsApiService service
...
@return SearchQuery*/
func (a *GlobalsApiService) OrganizationsOrganizationIdAccountsAccountIdGlobalsSearchQueryGet(ctx context.Context, query string, accountId string, organizationId string) (SearchQuery, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		successPayload     SearchQuery
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/organizations/{organization_id}/accounts/{account_id}/globals/search/{query}"
...
@param organizationId Organization ID
@return */
func (a *GlobalsApiService) OrganizationsOrganizationIdAccountsAccountIdGlobalsSearchQueryOptions(ctx context.Context, query string, accountId string, organizationId string) (*http.Response, error) {
	var (
