...
type ServerStat struct {
	WeeklySavings float32 `json:"weekly_savings,omitempty"`

	HourlyCost float32 `json:"hourly_cost,omitempty"`

	AmiCount float32 `json:"ami_count,omitempty"`

	SnapshotCount float32 `json:"snapshot_count,omitempty"`
}
