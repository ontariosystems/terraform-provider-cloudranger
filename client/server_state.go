...
type ServerState struct {
	TotalServers float32 `json:"totalServers,omitempty"`

	ServersWithPolicies float32 `json:"serversWithPolicies,omitempty"`

	ServersWithSchedules float32 `json:"serversWithSchedules,omitempty"`
}
