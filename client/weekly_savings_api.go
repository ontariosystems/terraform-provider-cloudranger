...
type WeeklySavingsApiService service

/* WeeklySavingsApiService
Returns the weekly savings of an account
* @param ctx context.Context for authentication, logging, tracing, etc.
@param accountId
@param organizationId Organization ID
@return WeeklySaving*/
func (a *WeeklySavingsApiService) OrganizationsOrganizationIdAccountsAccountIdWeeklySavingsGet(ctx context.Context, accountId string, organizationId string) (WeeklySaving, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		successPayload     WeeklySaving
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/organizations/{organization_id}/accounts/{account_id}/weekly_savings"
...
@param organizationId Organization ID
@return */
func (a *WeeklySavingsApiService) OrganizationsOrganizationIdAccountsAccountIdWeeklySavingsOptions(ctx context.Context, accountId string, organizationId string) (*http.Response, error) {
	var (
