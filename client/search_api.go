...
@return Empty*/
func (a *SearchApiService) OrganizationsOrganizationIdAccountsAccountIdSearchGet(ctx context.Context, accountId string, organizationId string) (Empty, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/organizations/{organization_id}/accounts/{account_id}/search"
...
@param organizationId Organization ID
@return */
func (a *SearchApiService) OrganizationsOrganizationIdAccountsAccountIdSearchOptions(ctx context.Context, accountId string, organizationId string) (*http.Response, error) {
	var (
