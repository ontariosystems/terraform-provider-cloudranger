...
type BackupsCountsTagRequest struct {
	Tag *AmiRestoreRequestRestoreTags `json:"tag,omitempty"`

	Retention *BackupsCountsTagRequestRetention `json:"retention,omitempty"`
}
